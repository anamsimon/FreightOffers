...
using FreightOffers.ExternalService;
using FreightOffers.IService;
using FreightOffers.Service;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "FreightOffersAPI v1"));
            }
